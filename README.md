...
- High-detail racing replicas

The platform is optimized for speed, SEO, and scalability using modern web technologies.
...
- Optimized animations and hover effects

---

## 🛠️ Technologies Used

- **Next.js (App Router)** – SEO-friendly, server components, SSR
- **Wix Headless (Stores + Reviews + Orders APIs)** – Backend commerce engine
