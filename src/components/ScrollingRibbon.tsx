    ...
    <div className="mx-auto max-w-7xl px-4">
      <div className="relative overflow-hidden rounded-lg border border-red-500/40 shadow-[0_0_40px_hsl(var(--primary)/0.4)]">
        ...
        <div className="absolute inset-0 flex items-center justify-center opacity-30">
          <div className="relative h-[4px] w-full bg-black/60">
            <div className="animate-lane-move absolute inset-0 bg-[repeating-linear-gradient(90deg,white,white_20px,transparent_20px,transparent_40px)] opacity-40" />
          </div>
        </div>
        ...
        {/* Subtle Bottom Glow */}
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(255,255,255,0.3),transparent_70%)] opacity-30" />
      </div>
