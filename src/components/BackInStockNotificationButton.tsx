  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Button
          {...props}
          className="group relative flex items-center justify-center gap-3 overflow-hidden rounded-xl bg-gradient-to-r from-primary via-orange-500 to-primary px-8 py-7 text-lg font-extrabold uppercase tracking-wide text-white shadow-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_0_40px_hsl(var(--primary)/0.8)] active:scale-95"
        >
