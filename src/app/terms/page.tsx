...
export const metadata: Metadata = {
  ...
  description:
    "Read how Adipoli Diecast collects, uses, and protects your personal information when purchasing die-cast collectibles online.",
};
      ...
      <div className="space-y-14">
        ...
        <div className="space-y-4 text-center">
          ...
          <p className="mx-auto max-w-3xl leading-7 text-gray-300">
            At Adipoli Diecast, we respect your privacy and are committed to
        ...
        <div className="space-y-12 text-left">
          ...
          <section className="space-y-4 border-l-4 border-primary pl-6">
            ...
            <p className="leading-7 text-gray-300">You may request to:</p>
            <ul className="list-inside list-disc space-y-1 text-gray-300">
          ...
          <section className="space-y-4 border-l-4 border-primary pl-6">
            ...
            <p className="leading-7 text-gray-300">
              ...
              traffic, and improve performance. You may disable cookies through
          ...
          <section className="space-y-4 border-l-4 border-primary pl-6">
            ...
            <p className="leading-7 text-gray-300">
              ...
              reflected on this page. Continued use of the website constitutes
